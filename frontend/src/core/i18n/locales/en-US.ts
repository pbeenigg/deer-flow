...
export const enUS: Translations = {
  ...
  settings: {
    ...
    scheduler: {
      ...
      description: "Create scheduled tasks to automatically push content at specified times.",
      ...
      deleteConfirmDescription: "This task will be permanently deleted. This action cannot be undone.",
      ...
      emptyDescription: "Create a scheduled task to automatically push content at specified times.",
      fromTemplate: "From Template",
      taskName: "Task Name",
      taskNamePlaceholder: "e.g., Daily Tech News",
      taskType: "Task Type",
      taskTypeNewsDigest: "News Digest",
      taskTypeCustomQuery: "Custom Query",
      taskPrompt: "Prompt",
      taskPromptPlaceholder: "Enter the prompt for the agent to execute...",
      ...
      notifyConfig: "Channel Configuration",
      nextRunAt: "Next run",
      lastRunAt: "Last run",
      never: "Never",
      ...
      testNotify: "Test",
      testNotifySuccess: "Test notification sent successfully",
      testNotifyFailed: "Test notification failed",
      triggerTask: "Run Now",
      triggerSuccess: "Task triggered successfully",
      triggerFailed: "Failed to trigger task",
      channelEmail: "Email",
      channelWechat: "WeChat Work",
      channelTelegram: "Telegram",
      channelDingtalk: "DingTalk",
      emailToEmail: "Recipient Email",
      ...
      validationName: "Task name is required",
      validationPrompt: "Prompt is required",
      validationSchedule: "Schedule configuration is required",
      daysOfWeek: {
        monday: "Monday",
        tuesday: "Tuesday",
        wednesday: "Wednesday",
